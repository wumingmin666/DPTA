...
load_from='/media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage1_finetune_3VT_20_shot_text_lambda1/best_coco_bbox_mAP_50_epoch_280.pth'
...
model = dict(
    ...
    bbox_head=dict(type='YOLOHeadWithGraphLoss',
                   head_module=dict(type='YOLOWorldHeadModule',
                    ...
                    prototype_cfg=dict(
                        path='/media/Storage3/wmm/ICML/Medical-OD/checkpoints_text/lambda1_20shot_prior.pt',#prior
                        use_graph_loss =True,
...
test_evaluator = dict(type='mmdet.CocoMetric',
                       ...
                       classwise=True,
                       format_only=False,
                       outfile_prefix='./work_dirs/stage2_finetune_3VT_20_shot_text_lambda1/test_results'
                       )
...
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=5 bash ./tools/dist_train.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage2_finetune_3VT_20_shot_text_lambda1.py 1 --amp


# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=1 bash ./tools/dist_test.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage2_finetune_3VT_20_shot_text_lambda1.py  /media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage2_finetune_3VT_20_shot_text_lambda1/best_coco_bbox_mAP_50_epoch_25.pth 1