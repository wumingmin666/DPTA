...
load_from='/media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage1_finetune_CHAOS_5_shot_text/20260304_164522/best_coco_bbox_mAP_50_epoch_320.pth'
...
model = dict(
    ...
    bbox_head=dict(type='YOLOHeadWithGraphLoss',
                   head_module=dict(type='YOLOWorldHeadModule',
                    ...
                    prototype_cfg=dict(
                        path='/media/Storage3/wmm/ICML/Medical-OD/checkpoints_text/CHAOS_5shot_prior.pt',
                        use_graph_loss =True,
...
test_evaluator = dict(type='mmdet.CocoMetric',
                       ...
                       classwise=True,
                       format_only=False,
                       outfile_prefix='./work_dirs/stage2_finetune_CHAOS_5_shot_text/test_results'
                       )
...
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=7 bash ./tools/dist_train.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage2_finetune_CHAOS_5_shot_text.py 1 --amp


# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=1 bash ./tools/dist_test.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage1_finetune_CHAOS_5_shot.py /media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage2_finetune_EPFetal_10_shot/best_coco_bbox_mAP_50_epoch_580.pth 1