...
test_evaluator = dict(type='mmdet.CocoMetric',
                       ...
                       classwise=True,
                       format_only=False,
                       outfile_prefix='./work_dirs/stage1_finetune_3VT_20_shot_text_k5/test_results'
                       )
...
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=1 bash ./tools/dist_train.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage1_finetune_3VT_20_shot_text_k5.py 1 --amp


# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=1 bash ./tools/dist_test.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage1_finetune_3VT_10_shot_text_k5.py  /media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage1_finetune_3VT_10_shot_text_ablation/best_coco_bbox_mAP_50_epoch_400.pth 1