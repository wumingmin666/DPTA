...
load_from='/media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage1_finetune_CHAOS_MR_10_shot/20260120_002817/best_coco_bbox_mAP_50_epoch_240.pth'
...
train_data_root='/media/Storage3/wmm/ICML/data/CHAOS/MR/few-shot/10-shot'
train_ann_file='/media/Storage3/wmm/ICML/data/CHAOS/MR/few-shot/10-shot/annotations.json'
train_img_path='/media/Storage3/wmm/ICML/data/CHAOS/MR/few-shot/10-shot/images'

test_data_root='/media/Storage3/wmm/ICML/data/CHAOS/MR/test'
test_ann_file='/media/Storage3/wmm/ICML/data/CHAOS/MR/test/annotations.json'
test_img_path='/media/Storage3/wmm/ICML/data/CHAOS/MR/test'

val_data_root=test_data_root
val_ann_file= test_ann_file
val_img_path=test_img_path

class_text_path='/media/Storage3/wmm/ICML/data/texts/CHAOS.json'
...
model = dict(
    ...
    bbox_head=dict(type='YOLOHeadWithGraphLoss',
                   head_module=dict(type='YOLOWorldHeadModule',
                    ...
                    prototype_cfg=dict(
                        path='/media/Storage3/wmm/ICML/Medical-OD/checkpoints/CHAOS_MR_10shot_prior.pt',
                        use_graph_loss =True,
...
test_evaluator = dict(type='mmdet.CocoMetric',
                       ...
                       classwise=True,
                       format_only=False,
                       outfile_prefix='./work_dirs/stage2_finetune_CHAOS_MR_10_shot/test_results'
                       )
...
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=1 bash ./tools/dist_train.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage2_finetune_CHAOS_MR_10_shot.py 1 --amp
