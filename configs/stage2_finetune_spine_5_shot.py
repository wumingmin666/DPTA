...
load_from='/media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage1_finetune_spine_5_shot/20260302_170552/best_coco_bbox_mAP_50_epoch_420.pth'
persistent_workers = False
text_model = '/media/Storage3/wmm/ICML/pretrain_weight/clip-vit-base-patch32'

classes=("Spinal Canal",
    "Vertebral Arch Ossification Center",
    "Medullary Splay",
    "Medullary Cone",
    "Vertebral Ossification Center",
    "Dermal sinus")
train_data_root='/media/Storage3/wmm/ICML/data/spine/GE/src'
train_ann_file='/media/Storage3/wmm/ICML/data/spineGE5/annotations.json'
train_img_path='/media/Storage3/wmm/ICML/data/spine/GE/src'
val_data_root='/media/Storage3/wmm/ICML/data/spine/GE/src'
val_ann_file='/media/Storage3/wmm/ICML/data/spine/GE/test.json'####val改了test
val_img_path='/media/Storage3/wmm/ICML/data/spine/GE/src'
test_data_root='/media/Storage3/wmm/ICML/data/spine/GE/src'
test_ann_file='/media/Storage3/wmm/ICML/data/spine/GE/test.json'
test_img_path='/media/Storage3/wmm/ICML/data/spine/GE/src'
class_text_path='/media/Storage3/wmm/ICML/data/texts/spine_descriptions.json'
...
model = dict(
    ...
    backbone=dict(
        ...
        text_model=dict(
            ...
            frozen_modules=['all']),
        frozen_stages=4), #冻结视觉编码器的前4个stage
    ...
    bbox_head=dict(type='YOLOHeadWithGraphLoss',
                   head_module=dict(type='YOLOWorldHeadModule',
                                     embed_dims=text_channels,
                                     num_classes=num_training_classes),

                    prototype_cfg=dict(
                        path='/media/Storage3/wmm/ICML/Medical-OD/checkpoints_new/spine_5shot_prior.pt',
                        use_graph_loss =True,
                        weight_graph_loss=10.0   
                    )
                    ),
...
test_evaluator = dict(type='mmdet.CocoMetric',
                       ...
                       classwise=True,
                       format_only=False,
                       outfile_prefix='./work_dirs/stage2_finetune_spine_5_shot/test_results'
                       )
...
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=7 bash ./tools/dist_train.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage2_finetune_spine_5_shot.py 1 --amp
...
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=6 bash ./tools/dist_test.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage2_finetune_3VT_10_shot.py  /media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage2_finetune_3VT_10_shot/20260111_142133_train_sim1/best_coco_bbox_mAP_50_epoch_100.pth 1
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=7 bash ./tools/dist_test.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage2_finetune_spine_5_shot.py  /media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage2_finetune_spine_5_shot/best_coco_bbox_mAP_50_epoch_160.pth 1