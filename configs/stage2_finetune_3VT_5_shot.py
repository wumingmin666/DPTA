...
load_from='/media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage1_finetune_3VT_5_shot/best_coco_bbox_mAP_50_epoch_700.pth'
...
train_ann_file='/media/Storage3/wmm/ICML/data/fetus_annotations_coco/3VT/c1/train/new1_base_novel/train_novel_5shot.json'
...
model = dict(
    ...
    bbox_head=dict(type='YOLOHeadWithGraphLoss',
                   head_module=dict(type='YOLOWorldHeadModule',
                    ...
                    prototype_cfg=dict(
                        path='/media/Storage3/wmm/ICML/Medical-OD/checkpoints/3VT_5shot_prior.pt',#prior
                        use_graph_loss =True,
...
test_evaluator = dict(type='mmdet.CocoMetric',
                       ...
                       classwise=True,
                       format_only=False,
                       outfile_prefix='./work_dirs/stage2_finetune_3VT_5_shot/test_results'
                       )
...
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=1 bash ./tools/dist_train.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage2_finetune_3VT_5_shot.py 1 --amp
...
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=1 bash ./tools/dist_test.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage2_finetune_3VT_5_shot.py  /media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage2_finetune_3VT_5_shot/best_coco_bbox_mAP_50_epoch_180.pth 1