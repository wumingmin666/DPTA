...
load_from = '/media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage1_finetune_CHAOS_MR_5_shot/20260120_141713/best_coco_bbox_mAP_50_epoch_220.pth'
...
train_data_root='/media/Storage3/wmm/ICML/data/CHAOS/MR/few-shot/5-shot'
train_ann_file='/media/Storage3/wmm/ICML/data/CHAOS/MR/few-shot/5-shot/annotations.json'
train_img_path='/media/Storage3/wmm/ICML/data/CHAOS/MR/few-shot/5-shot/images'
...
model = dict(
    ...
    bbox_head=dict(type='YOLOHeadWithGraphLoss',
                   head_module=dict(type='YOLOWorldHeadModule',
                    ...
                    prototype_cfg=dict(
                        path='/media/Storage3/wmm/ICML/Medical-OD/checkpoints/CHAOS_MR_5shot_prior.pt',
                        use_graph_loss =True,
...
test_evaluator = dict(type='mmdet.CocoMetric',
                       ...
                       classwise=True,
                       format_only=False,
                       outfile_prefix='./work_dirs/stage2_finetune_CHAOS_MR_5_shot/test_results'
                       )
...
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=1 bash ./tools/dist_train.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage2_finetune_CHAOS_MR_5_shot.py 1 --amp
