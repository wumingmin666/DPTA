...
load_from='/media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage1_finetune_3VT_20_shot_text_k1/best_coco_bbox_mAP_50_epoch_240.pth'
...
model = dict(
    ...
    bbox_head=dict(type='YOLOHeadWithGraphLoss1',
                   head_module=dict(type='YOLOWorldHeadModule',
                    ...
                    prototype_cfg=dict(
                        path='/media/Storage3/wmm/ICML/Medical-OD/checkpoints_text/k1_20shot_prior.pt',#prior
                        use_graph_loss =True,
                        topk_loss=1,
...
test_evaluator = dict(type='mmdet.CocoMetric',
                       ...
                       classwise=True,
                       format_only=False,
                       outfile_prefix='./work_dirs/stage2_finetune_3VT_20_shot_text_k1/test_results'
                       )
...
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=1 bash ./tools/dist_train.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage2_finetune_3VT_20_shot_text_k1.py 1 --amp


# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=1 bash ./tools/dist_test.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage2_finetune_3VT_20_shot_text_k1.py /media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage2_finetune_3VT_20_shot_text_k1/best_coco_bbox_mAP_50_epoch_40.pth 1