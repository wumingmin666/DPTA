...
load_from='/media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage1_finetune_EPFetal_20_shot/best_coco_bbox_mAP_50_epoch_1000.pth'
persistent_workers = False
text_model = '/media/Storage3/wmm/ICML/pretrain_weight/clip-vit-base-patch32'

classes=("thalami","nasal bone","palate","nasal skin","nasal tip","midbrain","nuchal translucency","IT","CM")
train_data_root='/media/Storage3/wmm/ICML/data/EP_Fetal_S_Detection_fewshot20'
train_ann_file='/media/Storage3/wmm/ICML/data/EP_Fetal_S_Detection_fewshot20/annotations.json'
train_img_path='/media/Storage3/wmm/ICML/data/EP_Fetal_S_Detection_fewshot20/images'

test_data_root='/media/Storage3/wmm/ICML/data/EP_Fetal_S_Detection'
test_ann_file='/media/Storage3/wmm/ICML/data/EP_Fetal_S_Detection/test.json'
test_img_path='/media/Storage3/wmm/ICML/data/EP_Fetal_S_Detection'

val_data_root=test_data_root
val_ann_file= test_ann_file
val_img_path=test_img_path
class_text_path='/media/Storage3/wmm/ICML/data/texts/fetal.json'
...
model = dict(
    ...
    bbox_head=dict(type='YOLOHeadWithGraphLoss',
                   head_module=dict(type='YOLOWorldHeadModule',
                    ...
                    prototype_cfg=dict(
                        path='/media/Storage3/wmm/ICML/Medical-OD/checkpoints/EPFetal_20shot_prior.pt',
                        use_graph_loss =True,
...
test_evaluator = dict(type='mmdet.CocoMetric',
                       ...
                       classwise=True,
                       format_only=False,
                       outfile_prefix='./work_dirs/stage2_finetune_EPFetal_20_shot/test_results'
                       )
...
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=1 bash ./tools/dist_train.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage2_finetune_EPFetal_20_shot.py 1 --amp
...
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=1 bash ./tools/dist_test.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage2_finetune_EPFetal_10_shot.py /media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage2_finetune_EPFetal_10_shot/best_coco_bbox_mAP_50_epoch_580.pth 1