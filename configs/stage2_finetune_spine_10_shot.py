...
load_from='/media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage1_finetune_spine_10_shot/20260112_132313_train/best_coco_bbox_mAP_50_epoch_400.pth'
...
train_ann_file='/media/Storage3/wmm/ICML/data/spineGE10/annotations.json'
train_img_path='/media/Storage3/wmm/ICML/data/spine/GE/src'
val_data_root='/media/Storage3/wmm/ICML/data/spine/GE/src'
val_ann_file='/media/Storage3/wmm/ICML/data/spine/GE/val.json'
...
model = dict(
    ...
    bbox_head=dict(type='YOLOHeadWithGraphLoss',
                   head_module=dict(type='YOLOWorldHeadModule',
                    ...
                    prototype_cfg=dict(
                        path='/media/Storage3/wmm/ICML/Medical-OD/checkpoints/spine_prior.pt',
                        use_graph_loss =True,
...
test_evaluator = dict(type='mmdet.CocoMetric',
                       ...
                       classwise=True,
                       format_only=False,
                       outfile_prefix='./work_dirs/stage2_finetune_spine_10_shot/test_results'
                       )
...
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=1 bash ./tools/dist_train.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage2_finetune_spine_10_shot.py 1 --amp
...
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=6 bash ./tools/dist_test.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage2_finetune_spine_10_shot.py  /media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage2_finetune_spine_10_shot/best_coco_bbox_mAP_50_epoch_40.pth 1