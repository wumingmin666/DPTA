...
model = dict(
    ...
    bbox_head=dict(type='YOLOHeadWithGraphLoss',
                   head_module=dict(type='YOLOWorldHeadModule',
                    ...
                    prototype_cfg=dict(
                        path='/media/Storage3/wmm/ICML/Medical-OD/checkpoints/3VT_10shot_prior_demo.pt',#prior
                        use_graph_loss =True,
...
test_evaluator = dict(type='mmdet.CocoMetric',
                       ...
                       classwise=True,
                       format_only=False,
                       outfile_prefix='./work_dirs/stage2_finetune_3VT_10_shot/test_results'
                       )
...
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=1 bash ./tools/dist_train.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage2_finetune_3VT_10_shot.py 1 --amp
...
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=6 bash ./tools/dist_test.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage2_finetune_3VT_10_shot.py  /media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage2_finetune_3VT_10_shot/20260110_122759_train_iou0.5_score0.001/best_coco_bbox_mAP_50_epoch_280.pth 1