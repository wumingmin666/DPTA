...
test_evaluator = dict(type='mmdet.CocoMetric',
                       ...
                       classwise=True,
                       format_only=False,
                       outfile_prefix='./work_dirs/stage1_finetune_spine_20_shot/test_results'
                       )
...
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=4 bash ./tools/dist_train.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage1_finetune_spine_20_shot.py 1 --amp


# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=4 bash ./tools/dist_test.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage1_finetune_spine_20_shot.py  /media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage1_finetune_spine_20_shot/20260303_163545/best_coco_bbox_mAP_50_epoch_820.pth 1