...
test_evaluator = dict(type='mmdet.CocoMetric',
                       ...
                       classwise=True,
                       format_only=False,
                       outfile_prefix='./work_dirs/stage1_finetune_3VT_20_shot_text/test_results'
                       )
...
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=5 bash ./tools/dist_train.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage1_finetune_3VT_20_shot_text.py 1 --amp
