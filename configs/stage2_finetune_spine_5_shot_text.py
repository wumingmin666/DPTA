...
load_from='/media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage1_finetune_spine_5_shot_text/20260303_112435/best_coco_bbox_mAP_50_epoch_1240.pth'
...
model = dict(
    ...
    bbox_head=dict(type='YOLOHeadWithGraphLoss',
                   head_module=dict(type='YOLOWorldHeadModule',
                    ...
                    prototype_cfg=dict(
                        path='/media/Storage3/wmm/ICML/Medical-OD/checkpoints_text/spine_5shot_prior.pt',
                        use_graph_loss =True,
...
test_evaluator = dict(type='mmdet.CocoMetric',
                       ...
                       classwise=True,
                       format_only=False,
                       outfile_prefix='./work_dirs/stage2_finetune_spine_5_shot_text/test_results'
                       )
...
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=7 bash ./tools/dist_train.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage2_finetune_spine_5_shot_text.py 1 --amp

# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=7 bash ./tools/dist_test.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage2_finetune_spine_5_shot_text.py  /media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage2_finetune_spine_5_shot_text/20260303_132814/best_coco_bbox_mAP_50_epoch_40.pth 1