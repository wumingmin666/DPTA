...
load_from='/media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage1_finetune_CHAOS_MR_20_shot_text/20260304_180606/best_coco_bbox_mAP_50_epoch_120.pth'
...
model = dict(
    ...
    bbox_head=dict(type='YOLOHeadWithGraphLoss',
                   head_module=dict(type='YOLOWorldHeadModule',
                    ...
                    prototype_cfg=dict(
                        path='/media/Storage3/wmm/ICML/Medical-OD/checkpoints_text/CHAOS_MR_20shot_prior.pt',
                        use_graph_loss =True,
...
test_evaluator = dict(type='mmdet.CocoMetric',
                       ...
                       classwise=True,
                       format_only=False,
                       outfile_prefix='./work_dirs/stage2_finetune_CHAOS_MR_20_shot_text_method2/test_results'
                       )
...
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=3 bash ./tools/dist_train.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage2_finetune_CHAOS_MR_20_shot_text_method2.py 1 --amp
