...
# load_from='/media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage1_finetune_3VT_10_shot/20260107_121109_train/best_coco_bbox_mAP_50_epoch_480.pth'
...
test_evaluator = dict(type='mmdet.CocoMetric',
                       ...
                       classwise=True,
                       format_only=False,
                       outfile_prefix='./work_dirs/stage1_finetune_spine_10_shot/test_results'
                       )
...
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=1 bash ./tools/dist_train.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage1_finetune_spine_10_shot.py 1 --amp
...
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=2 bash ./tools/dist_test.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage1_finetune_3VT_10_shot.py  /media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage1_finetune_3VT_10_shot/20260107_121109_train/best_coco_bbox_mAP_50_epoch_480.pth 1
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=1 bash ./tools/dist_test.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage1_finetune_spine_10_shot.py  /media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage1_finetune_spine_10_shot/20260303_140422/best_coco_bbox_mAP_50_epoch_740.pth 1