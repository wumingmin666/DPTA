...
load_from='/media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage1_finetune_3VT_10_shot_text/20260304_133912/best_coco_bbox_mAP_50_epoch_360.pth'
...
model = dict(
    ...
    bbox_head=dict(type='YOLOHeadWithGraphLoss',
                   head_module=dict(type='YOLOWorldHeadModule',
                    ...
                    prototype_cfg=dict(
                        path='/media/Storage3/wmm/ICML/Medical-OD/checkpoints_text/3VT_10shot_prior.pt',#prior
                        use_graph_loss =True,
...
test_evaluator = dict(type='mmdet.CocoMetric',
                       ...
                       classwise=True,
                       format_only=False,
                       outfile_prefix='./work_dirs/stage2_finetune_3VT_10_shot_text_method2/test_results'
                       )
...
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=3 bash ./tools/dist_train.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage2_finetune_3VT_10_shot_text_method2.py 1 --amp


# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=3 bash ./tools/dist_test.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage2_finetune_3VT_10_shot_text_method2.py  /media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage2_finetune_3VT_10_shot_text_method2/best_coco_bbox_mAP_50_epoch_35.pth 1