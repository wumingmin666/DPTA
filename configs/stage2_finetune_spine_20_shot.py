...
load_from='/media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage1_finetune_spine_20_shot/best_coco_bbox_mAP_50_epoch_240.pth'
...
train_ann_file='/media/Storage3/wmm/ICML/data/spineGE20/annotations.json'
...
model = dict(
    ...
    bbox_head=dict(type='YOLOHeadWithGraphLoss',
                   head_module=dict(type='YOLOWorldHeadModule',
                    ...
                    prototype_cfg=dict(
                        path='/media/Storage3/wmm/ICML/Medical-OD/checkpoints/spine_20shot_prior.pt',
                        use_graph_loss =True,
...
test_evaluator = dict(type='mmdet.CocoMetric',
                       ...
                       classwise=True,
                       format_only=False,
                       outfile_prefix='./work_dirs/stage2_finetune_spine_20_shot/test_results'
                       )
...
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=7 bash ./tools/dist_train.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage2_finetune_spine_20_shot.py 1 --amp
...
# TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=7 bash ./tools/dist_test.sh /media/Storage3/wmm/ICML/Medical-OD/configs/stage2_finetune_spine_20_shot.py  /media/Storage3/wmm/ICML/Medical-OD/work_dirs/stage2_finetune_spine_20_shot/best_coco_bbox_mAP_50_epoch_60.pth 1